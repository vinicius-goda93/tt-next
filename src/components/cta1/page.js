...
export function CTA1() {
    return (
        <section className="cta-one stage-padding">
                ...
                <div className="row">
                    <div className="col-lg-5 d-flex align-items-center">
                        <div>
                            ...
                            <Link href="#" className="main-button">Entre em contato agora mesmo</Link>
                        </div>
                    </div>

                    <div className="offset-xl-1 col-xl-6 col-lg-7">
                        <div className="cta-one-img">
                            {/* <img src="img/cta-1-img.png" alt="Estratégias de marketing profissionais" title="Estratégias de marketing profissionais"> */}
                        </div>
                    </div>
                </div>
            </div>
